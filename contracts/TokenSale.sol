...
contract RequestToken is StandardToken, Ownable {
    string  public  constant name = "Aker Token";
    string  public  constant symbol = "AKE";
 ...
 * @author Request.network
 */
contract TokenSale is Ownable, CappedCrowdsale, WhitelistedCrowdsale, ProgressiveIndividualCappedCrowdsale {
    ...
    // Token sale rate from ETH to Token
    uint private constant RATE_ETH_TOKEN = 5000;

    // Token initialy distributed for the team (15%)
    address public constant TEAM_VESTING_WALLET = 0x168760091896AaE65298Eb1202af3B3c960C2836;
    uint public constant TEAM_VESTING_AMOUNT = 150000000e18;

    address public constant WALLET = 0x168760091896AaE65298Eb1202af3B3c960C2836;
    ...
    constructor(uint256 _startTime, uint256 _endTime)
      ...
      StandardCrowdsale(_startTime, _endTime, RATE_ETH_TOKEN, WALLET)
    {
    ...
    function createTokenContract () 
      ...
      returns(StandardToken) 
    {
        return new RequestToken(TOTAL_REQUEST_TOKEN_SUPPLY, endTime.add(PERIOD_AFTERSALE_NOT_TRANSFERABLE_IN_SEC), WALLET);
    }
